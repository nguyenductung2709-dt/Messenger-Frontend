                ...
                {dropdownVisible && (
                    <div className="absolute right-0 mt-2 bg-white divide-y divide-gray-100 rounded-lg shadow w-60 dark:bg-gray-700">
                        ...
                        <ul className="w-full py-2 text-sm border-gray-600 text-gray-700 dark:text-gray-200 border-none">
                            {friends.map(friend => (
                                <li key={friend.id} className="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                    <img className="w-10 h-10 rounded-full mr-2" alt="Avatar" src={friend.user.avatarName} />
                                    <span className="mr-2">{friend.user.firstName} {friend.user.middleName} {friend.user.lastName}</span>
                                    <input 
                                        type="checkbox" 
                        ...
                        <button className = "border-none w-full focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-500 hover:bg-blue-700 text-white" onClick = {handleFormGroup}> Form Group </button>
                    </div>
                )}
            </div>
